...
if __name__ == "__main__":
    ...
    # start = '2014120100'
    # end = '2015010100'
    # cnt_limit = 10, -1获取全部的数据

    keyword = '郭广昌'
    start = '2015120100'
    end = '2016020100'
    cnt_limit = 10000000
    out_name = 'data/郭广昌.txt'
    ...
    count = 0
    wait_for_write = []
    for web_data in list_web_data:

        dat =  json.loads(web_data['w:'])

        # 打印
        # print '>>>', dat['fldUrlAddr']
        # print '>>>', dat['webname']
        # print '>>>', dat['fldtitle']
        # print '>>>', dat['fldAuthor']
        # print '>>>', dat['Fldcontent']
        # print '>>>', dat['fldrecddate']
        ...
        di = {
                ...
                'website': dat['webname'],
                'title': dat['fldtitle'],
                'author': dat['fldAuthor'],
                'content': dat['Fldcontent'],
                'created_time': dat['fldrecddate']
        }

        wait_for_write.append(di)

    json.dump(wait_for_write, open(out_name, 'w'), indent=4)
